...
export const otpVerification = (email, otp)=> async(dispatch)=>{
    ...
    await axios.post("https://boighor-backend.onrender.com/api/v1/auth/verify-otp", {email, otp}, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
...
export const login = (data)=> async(dispatch)=>{
    ...
    await axios.post("https://boighor-backend.onrender.com/api/v1/auth/login", data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
...
export const logout = ()=> async(dispatch)=>{
    ...
    await axios.get("https://boighor-backend.onrender.com/api/v1/auth/logout", {
        withCredentials: true,
    }).then(res=>{
...
export const getUser = ()=> async(dispatch)=>{
    ...
    await axios.get("https://boighor-backend.onrender.com/api/v1/auth/me", {
        withCredentials: true,
    }).then(res=>{
...
export const forgotPassword = (email)=> async(dispatch)=>{
    ...
    await axios.post("https://boighor-backend.onrender.com/api/v1/auth/password/forgot", {email}, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
...
export const resetPassword = (data, token)=> async(dispatch)=>{
    ...
    await axios.put(`https://boighor-backend.onrender.com/api/v1/auth/password/reset/${token}`, data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
...
export const updatePassword = (data)=> async(dispatch)=>{
    ...
    await axios.put(`https://boighor-backend.onrender.com/api/v1/auth/password/update`, data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
