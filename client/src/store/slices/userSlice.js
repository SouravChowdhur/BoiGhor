...
export const fetchAllUsers = () => async (dispatch) => {
    ...
    await axios.get("https://boighor-backend.onrender.com/api/v1/user/all", { withCredentials: true }).then((res) => {
...
export const addNewAdmin = (data) => async (dispatch) => {
    ...
    await axios.post("https://boighor-backend.onrender.com/api/v1/user/add/new-admin", data, { withCredentials: true, headers: {"Content-Type": "multipart/form-data",} }).then((res) => {
